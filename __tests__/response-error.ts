...
describe('Test error classes', () => {
  ...
  test('WebapiRegularError', (done) => {
    ...
    let error = new WebapiRegularError(body, headers, statusCode)
  ...
  test('WebapiAuthenticationError', (done) => {
    ...
    let error = new WebapiAuthenticationError(body, headers, statusCode)
  ...
  test('WebapiPlayerError', (done) => {
    ...
    let error = new WebapiPlayerError(body, headers, statusCode)
